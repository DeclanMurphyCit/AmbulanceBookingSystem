...
<script>
    ...
    function getWardList()
    {
        ...
        jQuery.ajax({
            ...
            dataType: 'json',
            data: ({wardId : wardId}),
            url: '<%=request.getContextPath()%>/ambbooking/getPatientsInWard',
            success: function (data) {
                if (data != "({})") {
                    jQuery.each(data, function(index, element) {
                        optionsString+='<option value="'+element.id+'">'+element.firstName+' '+element.lastName+'</option>';
                    });
                    jQuery("#patientId").append(optionsString);
                }
            },
            error: function (e) {
                console.log("error" + e);
    ...
    jQuery(document).ready(function () {
        ...
        jQuery('#dateOfTransfer').trigger('click');
