...
%>
<div id="main-panel" align="center"  style="width:470px;">
    <% }  else {%>
        <div id="main-panel" align="center"  style="width:270px;">
    <% } %>
    <c:choose>
        ...
        <form name="f" action="<c:url value="/j_spring_security_check"></c:url>" method="post" role="form">
