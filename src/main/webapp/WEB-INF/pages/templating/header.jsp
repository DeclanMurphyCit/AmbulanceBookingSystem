...
%>
        ...
        <security:authorize access="isFullyAuthenticated()">
        <button class="btn btn-navbar" style="width: 48%;" onclick="window.location.href='<%request.getContextPath();%>${url}'">Logout</button>
        </security:authorize>
        <security:authorize access="isAnonymous()">
        <button class="btn btn-navbar" style="width: 48%;" onclick="window.location.href='<%request.getContextPath();%>/AmbulanceBookingSystem/login'">Login</button>
        </security:authorize>
